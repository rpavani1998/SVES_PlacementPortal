...
<<<<<<< HEAD:client/src/app/user-login/user-login.component.ts
...
import { User } from '../../models/user';
import { UserService } from '../../services/user/user.service';
>>>>>>> 7d2bba97b9eb2faa3acbfa42495cd98f7680fdd3:client/src/app/components/user-login/user-login.component.ts
